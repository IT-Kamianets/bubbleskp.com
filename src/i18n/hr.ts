...
export const hr = {
	...
	'Open Bubbles KP Instagram page': 'Otvori Instagram stranicu Bubbles KP',
	'Open Bubbles KP location in Google Maps': 'Otvori lokaciju Bubbles KP u Google Maps',
	Quests: 'Quests',
	...
	'Check back later to see photos from Bubbles KP.':
		'Navratite kasnije kako biste vidjeli fotografije iz Bubbles KP.',
