...
export const ua = {
	...
	Socials: 'Соцмережі',
	'Stay connected with Bubbles KP': 'Залишайтеся на зв’язку з Bubbles KP',
	...
	'Check back later to see photos from Bubbles KP.':
		'Завітайте пізніше, щоб побачити фото з Bubbles KP.',
	...
	Events: 'Події',
	Jobs: 'Вакансії',
	'No rooms available at the moment': 'Наразі вільних номерів немає',
	'Check back later for room updates and availability.':
		'Завітайте пізніше, щоб дізнатися про оновлення та наявність номерів.',
