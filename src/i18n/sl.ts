...
export const sl = {
	...
	'Stay connected with Bubbles KP': 'Ostanite povezani s Bubbles KP',
	...
	'Open Bubbles KP Instagram page': 'Odpri Instagram stran Bubbles KP',
	'Open Bubbles KP location in Google Maps': 'Odpri lokacijo Bubbles KP v Google Maps',
	Quests: 'Quests',
	...
	'Check back later to see photos from Bubbles KP.':
		'Vrnite se pozneje in si oglejte fotografije iz Bubbles KP.',
	...
	'Ask restaurant staff for portion details':
		'Vprašajte osebje restavracije za podrobnosti o porciji',
